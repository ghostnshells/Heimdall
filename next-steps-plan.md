# Panoptes SaaS Transformation Plan

## Context

Panoptes is a vulnerability monitoring dashboard (React + Express) with 24 hardcoded assets cached globally. It needs to:
...
- Create/connect to `server/db/panoptes.db`
